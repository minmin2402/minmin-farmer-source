...
const main = require("./main-BQUQm_eV.cjs");
...
(function(exports$1) {
  ...
  var __importStar = main.commonjsGlobal && main.commonjsGlobal.__importStar || /* @__PURE__ */ function() {
...
class RealmStorage {
  ...
  findRealms(filter) {
    ...
    return Array.from(__privateGet(this, _realmMap).values()).filter((realm) => {
      ...
      if (filter.sandbox !== void 0 && (!(realm instanceof WindowRealm_js_1.WindowRealm) || sandboxFilterValue !== realm.sandbox)) {
        return false;
      }
...
class BidiConnection extends main.EventEmitter {
  constructor(url, transport, idGenerator, delay = 0, timeout) {
    ...
    __privateSet(this, _callbacks, new main.CallbackRegistry(idGenerator));
  ...
  send(method, params, timeout) {
    if (__privateGet(this, _closed)) {
      return Promise.reject(new main.ConnectionClosedError("Connection closed."));
    }
...
class BidiDeviceRequestPrompt extends main.DeviceRequestPrompt {
...
let Navigation = (() => {
  ...
  return _a3 = class extends _classSuper {
    ...
    const sessionEmitter = __privateGet(this, _disposables2).use(new main.EventEmitter(__privateGet(this, _Navigation_instances, session_get)));
...
let Request = (() => {
  ...
  return _a3 = class extends _classSuper {
    ...
    async fetchPostData() {
      ...
      if (!__privateGet(this, _requestBodyPromise)) {
        __privateSet(this, _requestBodyPromise, (async () => {
          ...
          throw new main.UnsupportedOperation(`Collected request body data of type ${data.result.bytes.type} is not supported`);
        })());
      }
        ...
        __privateSet(this, _responseContentPromise, (async () => {
          try {
            ...
            if (error instanceof main.ProtocolError && error.originalMessage.includes("No resource with given identifier found")) {
              throw new main.ProtocolError("Could not load response body for this request. This might happen if the request is a preflight request.");
            }
            throw error;
          }
        })());
    ...
    const sessionEmitter = __privateGet(this, _disposables2).use(new main.EventEmitter(__privateGet(this, _Request_instances, session_get)));
...
let UserPrompt = (() => {
  ...
  return _a3 = class extends _classSuper {
    ...
    const sessionEmitter = __privateGet(this, _disposables2).use(new main.EventEmitter(__privateGet(this, _UserPrompt_instances, session_get)));
...
let BrowsingContext = (() => {
  ...
  return _a3 = class extends _classSuper {
    ...
    [(_dispose_decorators = [main.inertIfDisposed], _activate_decorators = [main.throwIfDisposed((context) => {
      ...
      return __privateGet(context, _reason);
    })], _setTouchOverride_decorators = [main.throwIfDisposed((context) => {
      return __privateGet(context, _reason);
      ...
      return __privateGet(context, _reason);
    })], _setScreenOrientationOverride_decorators = [main.throwIfDisposed((context) => {
      return __privateGet(context, _reason);
    ...
    const sessionEmitter = __privateGet(this, _disposables2).use(new main.EventEmitter(__privateGet(this, _BrowsingContext_instances, session_get)));
    ...
    sessionEmitter.on("browsingContext.navigationStarted", (info) => {
      ...
      const navigationEmitter = __privateGet(this, _disposables2).use(new main.EventEmitter(__privateGet(this, _navigation)));
...
let UserContext = (() => {
  ...
  return _a3 = class extends _classSuper {
    ...
    const sessionEmitter = __privateGet(this, _disposables2).use(new main.EventEmitter(__privateGet(this, _UserContext_instances, session_get)));
    sessionEmitter.on("browsingContext.contextCreated", (info) => {
      if (info.parent) {
        return;
      }
...
class BidiHTTPRequest extends main.HTTPRequest {
  ...
  interceptResolutionState() {
    if (!__privateGet(this, _request2).isBlocked) {
      return { action: main.InterceptResolutionAction.Disabled };
    }
...
function rewriteNavigationError(message, ms) {
  return (error) => {
    ...
    } else if (error instanceof main.TimeoutError$1) {
...
evaluate_fn = async function(returnByValue, pageFunction, ...args) {
  var _a3;
  const sourceUrlComment = main.getSourceUrlComment(((_a3 = main.getSourcePuppeteerURLIfAvailable(pageFunction)) == null ? void 0 : _a3.toString()) ?? main.PuppeteerURL.INTERNAL_URL);
  let responsePromise;
  ...
  return _a3 = class extends _classSuper {
    ...
    this.browsingContext.on("log", ({ entry }) => {
      ...
      if (isConsoleLogEntry(entry)) {
        ...
        this.page().trustedEmitter.emit("console", new main.ConsoleMessage(convertConsoleMessageLevel(entry.method), text, args, getStackTraceLocations(entry.stackTrace), this, void 0));
    ...
    _frameElement_decorators = [main.throwIfDetached];
      ...
      if (!this.browser().cdpSupported) {
        ...
        if ((((_a4 = __privateGet(this, _viewport)) == null ? void 0 : _a4.hasTouch) ?? false) !== ((viewport == null ? void 0 : viewport.hasTouch) ?? false)) {
          ...
          commands.push(__privateGet(this, _frame6).browsingContext.setTouchOverride(maxTouchPoints).catch((error) => {
            if (error instanceof main.ProtocolError && (error.message.includes("unknown command") || error.message.includes("unsupported operation"))) {
              return;
            }
            throw error;
          }));
...
let BidiBrowserContext = (() => {
  ...
  return _a3 = class extends _classSuper {
    ...
    async setPermission(origin, ...permissions) {
      if (origin === "*") {
        throw new main.UnsupportedOperation("Origin (*) is not supported by WebDriver BiDi");
      }
      await Promise.all(permissions.map((permission) => {
        if (permission.permission.allowWithoutSanitization) {
          throw new main.UnsupportedOperation("allowWithoutSanitization is not supported by WebDriver BiDi");
        }
        if (permission.permission.panTiltZoom) {
          throw new main.UnsupportedOperation("panTiltZoom is not supported by WebDriver BiDi");
        }
        if (permission.permission.userVisibleOnly) {
          throw new main.UnsupportedOperation("userVisibleOnly is not supported by WebDriver BiDi");
        }
  ...
  return _a3 = class extends _classSuper {
    ...
    async createUserContext(options) {
      ...
      if (((_a4 = options.downloadBehavior) == null ? void 0 : _a4.policy) === "allowAndName") {
        throw new main.UnsupportedOperation("`allowAndName` is not supported in WebDriver BiDi");
      }
      if (((_b2 = options.downloadBehavior) == null ? void 0 : _b2.policy) === "allow") {
        if (options.downloadBehavior.downloadPath === void 0) {
          throw new main.UnsupportedOperation("`downloadPath` is required in `allow` download behavior");
        }
    ...
    [(_dispose_decorators = [main.inertIfDisposed], _close_decorators = [main.throwIfDisposed((browser) => {
      ...
      return __privateGet(browser, _reason);
    })], _setClientWindowState_decorators = [main.throwIfDisposed((browser) => {
      return __privateGet(browser, _reason);
    })], _getClientWindowInfo_decorators = [main.throwIfDisposed((browser) => {
      return __privateGet(browser, _reason);
    })], main.disposeSymbol)]() {
...
let BidiBrowser = (() => {
  ...
  let _classSuper = main.Browser$1;
